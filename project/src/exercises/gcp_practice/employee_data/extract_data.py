...
bucket_name = 'gcp_practice_employee-data'  # Replace with your bucket name
destination_blob_name = 'employee_data.csv'  # Replace with the desired path in your bucket
